...
class CClockAppBar extends StatefulWidget {
  CClockAppBar({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _CClockAppBarState createState() => _CClockAppBarState();
}

class _CClockAppBarState extends State<CClockAppBar>
                ...
                style: TextStyle(
                  ...
                  shadows: [
                    Shadow(
                      ...
                      offset: Offset(elevation, elevation) * (subscribeH1 ? 1.0 - _animation.value : 1.0),
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  shadows: [
                    ...
                    Shadow(
                      color: Colors.white,
                      offset: Offset(-elevation, -elevation) * (subscribeS2 ? 1.0 - _animation.value : 1.0),
                      blurRadius: elevation *
                          10 /
                          3 *
                          (subscribeS2 ? 1.0 - _animation.value : 1.0),
